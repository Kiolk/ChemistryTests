                    ...
                    val itemTouchListener = recycler?.let { it1 ->
                        RecyclerTouchListener(it, it1, object : OnItemClickListener {
                            override fun onClick(view: View, position: Int) {
                                ...
                                testingActivity.showFragment(R.id.result_frame_layout, testingActivity.mHintFragment, com.github.kiolk.chemistrytests.ui.fragments.ChemTheoryFragment.Companion.THEORY_FRAGMENT_TAG)
